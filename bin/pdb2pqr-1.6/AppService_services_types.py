...
class nbcr_sdsc_edu_opal_types:
    ...
    class InputFileType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ...
                ZSI.TC.Base64String(pname="contents", aname="_contents"),
            ]
            ...
            ZSI.TCcompound.Struct.__init__(
                self,
                self.__class__,
                TClist,
                pname=name,
    ...
    class FlagsType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TC.String(pname="id", aname="_id"),
                ZSI.TC.String(pname="tag", aname="_tag"),
                ZSI.TC.String(pname="textDesc", aname="_textDesc", optional=1),
            ]
    ...
    class ImplicitParamsType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TC.String(pname="id", aname="_id"),
                ZSI.TC.String(pname="name", aname="_name", optional=1),
                ZSI.TC.String(pname="extension", aname="_extension", optional=1),
                ns1.IOType_Def(name="ioType", ns=ns),
                ZSI.TC.Boolean(pname="required", aname="_required", optional=1),
                ZSI.TC.String(pname="semanticType", aname="_semanticType", optional=1),
                ZSI.TC.String(pname="textDesc", aname="_textDesc", optional=1),
                ZSI.TCnumbers.Iint(pname="min", aname="_min", optional=1),
                ZSI.TCnumbers.Iint(pname="max", aname="_max", optional=1),
            ]
    ...
    class ParamsType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TC.String(pname="id", aname="_id"),
                ZSI.TC.String(pname="tag", aname="_tag", optional=1),
                ns1.ParamType_Def(name="paramType", ns=ns),
                ns1.IOType_Def(name="ioType", ns=ns, optional=1),
                ZSI.TC.Boolean(pname="required", aname="_required", optional=1),
                ZSI.TC.String(pname="value", aname="_value", repeatable=1, optional=1),
                ZSI.TC.String(pname="semanticType", aname="_semanticType", optional=1),
                ZSI.TC.String(pname="textDesc", aname="_textDesc", optional=1),
            ]
    ...
    class OutputFileType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TC.String(pname="name", aname="_name"),
                ZSI.TC.URI(pname="url", aname="_url"),
            ]
    ...
    class StatusOutputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TCnumbers.Iint(pname="code", aname="_code"),
                ZSI.TC.String(pname="message", aname="_message"),
                ZSI.TC.URI(pname="baseURL", aname="_baseURL"),
            ]
    ...
    class OutputsByNameInputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TC.String(pname="jobID", aname="_jobID"),
                ZSI.TC.String(pname="fileName", aname="_fileName"),
            ]
    ...
    class getOutputAsBase64ByNameOutput_Dec(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TCnumbers.Ibyte(
                    pname="item", aname="_item", repeatable=1, optional=1
                ),
            ]
    ...
    class JobInputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TC.String(pname="argList", aname="_argList", optional=1),
                ZSI.TCnumbers.Iint(pname="numProcs", aname="_numProcs", optional=1),
                ns1.InputFileType_Def(
                    name="inputFile", ns=ns, repeatable=1, optional=1
                ),
            ]
    ...
    class ImplicitParamsArrayType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ns1.ImplicitParamsType_Def(
                    name="param", ns=ns, repeatable=1, optional=1
                ),
            ]
    ...
    class ParamsArrayType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TC.String(pname="separator", aname="_separator", optional=1),
                ns1.ParamsType_Def(name="param", ns=ns, repeatable=1, optional=1),
            ]
    ...
    class JobOutputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TC.URI(pname="stdOut", aname="_stdOut", optional=1),
                ZSI.TC.URI(pname="stdErr", aname="_stdErr", optional=1),
                ns1.OutputFileType_Def(
                    name="outputFile", ns=ns, repeatable=1, optional=1
                ),
            ]
    ...
    class JobSubOutputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TC.String(pname="jobID", aname="_jobID"),
                ns1.StatusOutputType_Def(name="status", ns=ns),
            ]
    ...
    class ArgumentsType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ns1.FlagsArrayType_Def(name="flags", ns=ns, optional=1),
                ns1.ParamsArrayType_Def(name="taggedParams", ns=ns, optional=1),
                ns1.ParamsArrayType_Def(name="untaggedParams", ns=ns, optional=1),
                ns1.ImplicitParamsArrayType_Def(
                    name="implicitParams", ns=ns, optional=1
                ),
            ]
    ...
    class BlockingOutputType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ns1.StatusOutputType_Def(name="status", ns=ns),
                ns1.JobOutputType_Def(name="jobOut", ns=ns),
            ]
    ...
    class AppMetadataType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ZSI.TC.String(pname="usage", aname="_usage"),
                ZSI.TC.String(pname="info", aname="_info", repeatable=1, optional=1),
                ns1.ArgumentsType_Def(name="types", ns=ns, optional=1),
            ]
    ...
    class AppConfigType_Def(ZSI.TCcompound.Struct):
        ...
        def __init__(self, name=None, ns=None, **kw):
            ...
            TClist = [
                ns1.AppMetadataType_Def(name="metadata", ns=ns),
                ZSI.TC.String(pname="binaryLocation", aname="_binaryLocation"),
                ZSI.TC.String(pname="defaultArgs", aname="_defaultArgs", optional=1),
                ZSI.TC.Boolean(pname="parallel", aname="_parallel"),
            ]
